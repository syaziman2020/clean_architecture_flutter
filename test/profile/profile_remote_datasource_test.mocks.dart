...
// in clean_architecture_learn/test/profile/profile_remote_datasource_test.dart.
...
class MockProfileRemoteDataSource extends _i1.Mock
  ...
  @override
  _i4.Future<List<_i2.ProfileModel>> getAllProfiles(int? page) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAllProfiles,
          [page],
  ...
  @override
  _i4.Future<_i2.ProfileModel> getProfileById(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getProfileById,
          [id],
        ),
